...
This chapter is mainly based on 2 textbooks and 2 lectrue notes. The first book is \textbf{Modern Cosmology by} \citet{Dodelson_Schmidt_2026} and the second is \textbf{Spacetime and Geometry: An Introduction to General Relativity}. The first lecture notes come from the Advanced Cosmology course given the the Summer semester 2024 by Prof. Dr. Cristiano Poriciani and Jun-Prof. Andrina Nicola, and the second lecture notes come from the Weak Lesning course by prof. Dr. Peter Schneider given in the In this chapeter, I will introduce the basics of the principles of cosmology, weak gravitational lensing, and fast radio bursts (FRBs).
