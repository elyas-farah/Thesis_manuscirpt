...
Add a table showing the cosmological parameters, theri fiducial value and their prior. Look at the table in Kritti et al on the selection effects. Add the parameters that I fix and the parameter that I free. In addition, add the values for the parameters to model systematics and priors (in case I present the SBI).
